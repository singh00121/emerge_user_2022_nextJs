...
import Product from "../../StaticData/Laptop.json";
import Call from "../../public/assets/Footer/call.svg";
import Image from "next/image";

function LaptopBody() {
  const Data = Product.Laptop;
  console.log(Data);
  return (
    <>
                ...
                <div class="absolute my-rotate-y-180 backface-hidden w-full py-5 bg-slate-300  overflow-hidden rounded-lg">
                  <div class="text-center flex flex-col items-center justify-center py-5 text-gray-800 px-2 ">
                    ...
                    <ul className="text-xs justify-start text-left list-disc -ml-28">
                      ...
                      <li>Ganretion- {item.Ganretion}</li>
                      <li>Capacity - {item.SSD}</li>
                      <li>WiRAM - {item.Ram} GB </li>
                      <li>WDisplay - {item.Screensize}</li>
                    </ul>
